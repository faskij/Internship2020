...
sample_size_estimate <- ncells(m1 = m, pi1=pi, foldchange = fc, dropout = do, p = unique_gene_count, n = number_cells, mu = mean_expression, sigma = standard_deviation, type1 = alpha, dfactor, seed = seed_number, B = replicates, ncore = cores)
