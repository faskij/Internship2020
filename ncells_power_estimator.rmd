...
pi = 5                     # Percentage of subpopulation of cells in overall population; 5 <= pi <= 50
fc =  2                    # Expression fold change of desired subpopulation; 1 <= fc <= 32
...
number_cells = 100         # Vector of total number of cells; 50 <= min(number_cells), max(number_cells) <= 1000000
...
#dfactor=TRUE              # Option, Cutoff values to declare separation, depends on type 1 error rate
seed_number = 123          # pseudonumber vector, default 123
